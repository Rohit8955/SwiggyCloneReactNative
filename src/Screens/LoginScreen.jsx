  ...
  return (
    <View className='flex-1 items-center justify-center'>
        ...
        <TouchableOpacity onPress={loginclicked} activeOpacity={0.7} className='w-full px-6 mt-7'>
            <View className=' w-full bg-amber-500 flex items-center py-2 rounded-md'><Text className='text-white font-[600] text-[18px]'>Sign In</Text></View>
        </TouchableOpacity>
        ...
        <View className='mt-7'><View className='flex-row gap-3'>
            <TouchableOpacity activeOpacity={0.7} className='bg-white h-[42px] w-[42px] flex items-center justify-center rounded-full'><AntDesign name="google" size={24} color="black" /></TouchableOpacity>
